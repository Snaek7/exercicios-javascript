(function(){
  ...
  */
  var newSul = []; 
  brasil.forEach(function(itemBrasil){
    var result = sul.some(function(itemSul){
        return itemSul === itemBrasil;
    });
    if(result){
      newSul.push(itemBrasil);
    }
  });
  ...
  */
  var nordeste = ['Alagoas', 'Bahia','Ceará','Maranhão','Pernambuco'];
  ...
  */
  ...
  var todosMaiores = brasil.every(function(item){
